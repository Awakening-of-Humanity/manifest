...
![markdown logo](../images/mdp.svg =190x*)
...
<figure class="figure-right" style="width: 500px;">
    <a href="../images/example.jpg" target="_blank">
        <img src="../images/example.jpg" alt="an example image with caption" />
    </a>
...
<img class="img-left" src="../images/example.jpg" style="width: 500px;" alt="an example image" />
